...
public class OI {
	...
	//autoModeSelect has not been added to the DriverStation yet
	...
	public OI() {
		 ...
		 * SmartDashboard.putData("SetElevatorPosition", new
		 * SetElevatorPosition());
		 * 
		 ...
		 * 
		 * SmartDashboard.putData("ManipulatorManualControl", new
		 * ManipulatorManualControl());
		 * 
		 * SmartDashboard.putData("GradualDrive", new GradualDrive());
		 * 
		 * SmartDashboard.putData("AutoCalibrateElevator", new
		 * AutoCalibrateElevator());
		 * 
