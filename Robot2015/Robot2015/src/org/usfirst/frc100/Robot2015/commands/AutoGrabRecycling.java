...
public class AutoGrabRecycling extends Command {
	...
	public AutoGrabRecycling(int containers) {
		TIME_AFTER_INITIAL_DEPLOY = Preferences
				.getDouble("AutoGrabRecycling_TIME_AFTER_1ST_DEPLOY");
		TIME_AFTER_STAB = Preferences
				.getDouble("AutoGrabRecycling_TIME_AFTER_STAB");
		TIME_AFTER_DEPLOY = Preferences
				.getDouble("AutoGrabRecycling_TIME_AFTER_2ND_DEPLOY");
