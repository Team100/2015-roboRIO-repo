...
public class RobotMap {
	...
	public static void init() {
		...
		LiveWindow.addActuator("Drivetrain", "LeftMotor",
				(VictorSP) drivetrainLeftMotor);

		drivetrainRightMotor = new VictorSP(1);
		LiveWindow.addActuator("Drivetrain", "RightMotor",
				(VictorSP) drivetrainRightMotor);

		drivetrainRobotDrive = new RobotDrive(drivetrainLeftMotor,
		...
		LiveWindow.addActuator("Drivetrain", "SlideMotor",
				(VictorSP) drivetrainSlideMotor);
		...
		LiveWindow.addSensor("Drivetrain", "RightEncoder",
		...
		LiveWindow.addSensor("Drivetrain", "SlideEncoder",
				drivetrainSlideEncoder);
		...
		LiveWindow.addSensor("Drivetrain", "LeftLineReader",
				drivetrainLeftLineReader);

		drivetrainRightLineReader = new AnalogInput(3);
		LiveWindow.addSensor("Drivetrain", "RightLineReader",
