...
public class OI {
    ...
    public JoystickButton notScoringButton;
    ...
    public OI() {
        ...
        manualControlButton = new JoystickButton(manipulatorJoystick, 8);
        manualControlButton.whileHeld(new ManualControlElevator());
        notScoringButton = new JoystickButton(manipulatorJoystick, 7);
        ...
        butterflyButton.whenPressed(new DeployButterfly(false));
