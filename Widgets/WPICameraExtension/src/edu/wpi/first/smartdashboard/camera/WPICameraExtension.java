...
public class WPICameraExtension extends StaticWidget{
    ...
    public class GCThread extends Thread {
         ...
         *
         */
        public void WPICameraExtension(){
...
public final IPAddressProperty ipProperty = new IPAddressProperty(this, "Camera IP Address", new int[]{10, (prefs.team.getValue() / 100), (prefs.team.getValue() % 100), 20});
    @Override
    public void init() {
