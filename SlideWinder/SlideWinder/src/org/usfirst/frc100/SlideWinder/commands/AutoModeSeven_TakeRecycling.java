...
public class AutoModeSeven_TakeRecycling extends CommandGroup {
	...
	public AutoModeSeven_TakeRecycling() {
		...
		addParallel(new RaiseArm(false), 2);
		addSequential(new AutoSlideToLine(), 3);
