 ...
 * field.
 */
public class AutoModeFour_TakeRecyclingWithLineReaders extends CommandGroup {

	private final double SLIDE_DISTANCE;
	private final double DRIVE_DISTANCE;
	private final double DRIVE_DISTANCE2;

	public AutoModeFour_TakeRecyclingWithLineReaders() {
		...
		addSequential(new AutoFollowLine(DRIVE_DISTANCE));
		addParallel(new Immobilize());
		addSequential(new AutoGrabRecycling());
		addSequential(new AutoFollowLine(DRIVE_DISTANCE2));
		addParallel(new Immobilize());
		addSequential(new AutoGrabRecycling());
		addSequential(new AutoFollowLine(DRIVE_DISTANCE));
		addParallel(new Immobilize());
