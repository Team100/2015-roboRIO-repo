...
//	DoubleSolenoid brake = RobotMap.elevatorBrake;
	...
	private final double toteHeight = 11.75; 
	// inches, compensated for 0.35 difference between lip and actual
	private final double scoringPlatformHeight = 2.0; // inches
	private boolean topTriggered = false; 
	private final double stepHeight = 4.0; 
	// inches, compensated for the standard +2 in for scoring
