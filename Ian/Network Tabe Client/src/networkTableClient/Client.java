...
public class Client {
	...
	public void run() {
		...
		try {
			...
			//Constructs a NetworkTable variable called "table" that's associated with the "datatable" NetworkTable
			...
			while (true) {
				...
				boolean inSlideMode = table.getBoolean("inSlideMode", false);
				//Prints the data.
				...
				double leftControllerSpeed = table.getNumber("leftControllerSpeed", 0.0);
				//Prints the data.
				...
				double rightControllerSpeed = table.getNumber("rightControllerSpeed", 0.0);
				//Prints the data.
